...
import com.example.todoappjetpackcomposemvvm.util.Constants.PREFERENCE_KEY
import com.example.todoappjetpackcomposemvvm.util.Constants.PREFERENCE_NAME
...
class DataStoreRepository @Inject constructor(
    ...
    suspend fun persistSortData(priority: Priority) {
